...
SYSTEM_PROMPT = (
    ...
    "- Quote only numbers that appear in the receipt, and invent nothing. Round\n"
    "  if you like, but never past two significant digits — and round, never\n"
    "  truncate: dropping digits states a value the receipt does not carry.\n"
